...
interface SponsorFormEmailProps {
  firstName: string;
  lastName: string;
  email: string;
  phone: string;
...
export default function SponsorFormEmail({ firstName, lastName, email, phone, orgName }: SponsorFormEmailProps) {
  return (
    <Html>
      <Head />
      <Body style={{ fontFamily: "Arial, sans-serif", padding: "20px", backgroundColor: "#f4f4f4" }}>
        <Container style={{ maxWidth: "600px", backgroundColor: "#ffffff", padding: "20px", borderRadius: "5px" }}>
          <Heading style={{ color: "#333", textAlign: "center" }}>New Sponsor Form Submission</Heading>
          <Section>
