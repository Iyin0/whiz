...
export default function PartnershipForm() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    try {
      ...
      if (response.ok) {
        toast.success('Your partnership request has been sent!');
        form.reset();
      } else {
        throw new Error('Failed to send partnership request. Please try again.');
      }
  ...
  return (
    <div className="flex flex-col gap-6 pb-6">
      <p className="text-sm text-muted-foreground">Share your details and we will explore how your institution or network can partner with the work.</p>
      <Form {...form}>
